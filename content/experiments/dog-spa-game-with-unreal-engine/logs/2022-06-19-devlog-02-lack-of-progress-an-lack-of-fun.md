...
title: "Devlog 02: Lack of Progress and Feature Creep"
date: "2022-06-19T13:54:27.000Z"
updated: "2022-06-19T14:43:00.000Z"
type: "experiment-log"
tags: ["game design"]
parentExperiment: "dog-spa-game-with-unreal-engine"
logCategories: ["Brainstorming", "Programming", "Specification"]
projectStyles: ["Gamedev"]
tools: ["C++", "Unreal Engine"]
metaDescription: "After a month without progress, I&#039;m back to this gamedev experiment, but it&#039;s a Feature Creep mess and I can&#039;t find fun as in &quot;game&quot;. Onto the next idea!"
---

It's been almost a month since the [first devlog](https://alfredbaudisch.com/experiment-logs/devlog-01-camera-system-and-grid-based-construction/) of this gamedev experiment and since then I haven't developed the game anymore, because of a huge task I had to finish at work.

Now that I'm available again, I tried to resume making this game, but for now, **it's not clicking with me anymore**. This whole game idea started inspired by two other games: **[Capybara Spa](https://store.steampowered.com/app/1822910/Capybara_Spa/), but using Farming mechanics similar to [Farm Together](https://store.steampowered.com/app/673950/Farm_Together/).**
...
## Game Design in the Mind of an Software Architect

Due to me bringing my experience as a Software Architect and Data Scientist into Game Development, I turn most of my hobby gamedev projects, including this one, into a **[Feature Creep mess](https://youtu.be/tu_vljnsVdI?t=1154)**, **I focus too much on making systems instead of making a game**, afterall I consider Game Design to be much harder than anything else.
...
Maybe I should stick to the principles of [**Blatant and Blind Imitation**](https://www.youtube.com/watch?v=tu_vljnsVdI)? This way, **I wouldn't have to come up with something new, and I wouldn't even have to think about Game Design, I could just copy it and I could focus on what I do better: architect and implement systems**. This is also **the perfect way to create educational content and even ready-to-use packages** and assets to sell on the Asset Stores, **similarly to [Ryan Laley](https://www.youtube.com/c/RyanLaley)‘s channel or even my own [Zelda Breath of the Wild Inventory Course with Godot](https://alfredbaudisch.com/projects/education/dynamic-inventory-system-and-user-interfaces-with-godot-course/)**.

It also seems to me that creating [realistic simulators](https://store.steampowered.com/app/24010/Train_Simulator_Classic/) should be the way to go – afterall I also greatly enjoy [playing Simulators](https://store.steampowered.com/app/1248130/Farming_Simulator_22/). And [these Simulators](https://store.steampowered.com/publisher/playway/list/39592/) are just systems on top of systems and more systems.
...
<iframe width="750" height="422" src="https://www.youtube.com/embed/tu_vljnsVdI" title="Game design sins / Artyom Volkov (Ciliz)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
