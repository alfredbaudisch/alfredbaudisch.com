module.exports = {
  eleventyComputed: {
    permalink: function(data) {
      // Pages are in /pages/ directory, so check for that
      if (data.page && data.page.filePathStem && data.page.filePathStem.includes('/pages/')) {
        const pageSlug = data.page.filePathStem.split('/').pop();
        return `/${pageSlug}/`;
      }
