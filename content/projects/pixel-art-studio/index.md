...
metaDescription: "Blender add-on for pixel perfect pixel art texture painting. Draw and paint pixel art inside Blender. Selections (lasso, wand), layers, palettes, pixel size setup (texel density)."
links:
  - name: "itch.io"
