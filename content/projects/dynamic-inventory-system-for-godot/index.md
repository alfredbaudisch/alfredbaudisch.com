...
title: "Dynamic Inventory System for Godot"
date: "2022-05-04T22:11:08.000Z"
updated: "2022-05-04T22:34:57.000Z"
type: "project"
projectStyles: ["Gamedev"]
projectStatus: ["Completed", "Personal / Hobby"]
projectTypes: ["Open-source"]
tools: ["GDScript", "Godot"]
featuredImage: "/media/wp-content/2022/05/Ultimate-Godot-Inventory-Course-Thumb-Header2.jpg"
featuredImageThumb: "/media/wp-content/2022/05/Ultimate-Godot-Inventory-Course-Thumb-Header2-768x432.jpg"
featuredImageSmall: "/media/wp-content/2022/05/Ultimate-Godot-Inventory-Course-Thumb-Header2-300x169.jpg"
links:
  - name: "Github"
    url: "https://github.com/alfredbaudisch/GodotDynamicInventorySystem"
  - name: "Course"
    url: "https://alfredbaudisch.com/projects/education/dynamic-inventory-system-and-user-interfaces-with-godot-course/"
...
![](/media/wp-content/2022/05/GodotInventoryUI-System-CustomResources-FinalSystem3-1.gif)
...
This source-code is built from scratch in the [**Complete Godot Course: Game User Interfaces Masterclass (Building a Dynamic Inventory System and UI with Godot)**](https://alfredbaudisch.com/projects/education/dynamic-inventory-system-and-user-interfaces-with-godot-course/). If you want to **learn how to make ALL of this from scratch**, check the course, while also support this project.
...
### [](https://github.com/alfredbaudisch/GodotDynamicInventorySystem#asset-licenses)

### Asset Licenses

These notices must be included in projects that assets from this repository (see more and links [here](https://github.com/alfredbaudisch/GodotDynamicInventorySystem/blob/master/LICENSE_ASSETS.md)):
