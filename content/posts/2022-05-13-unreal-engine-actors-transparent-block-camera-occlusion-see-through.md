...
date: "2022-05-13T16:03:17.000Z"
updated: "2022-05-13T16:04:00.000Z"
tags: ["c++", "cpp", "source-code", "ue4"]
categories: ["Unreal Engine"]
featuredImage: "/media/wp-content/2022/05/UnrealEngine-See-Through-OccludedCameraActor.jpg"
featuredImageThumb: "/media/wp-content/2022/05/UnrealEngine-See-Through-OccludedCameraActor-768x465.jpg"
featuredImageSmall: "/media/wp-content/2022/05/UnrealEngine-See-Through-OccludedCameraActor-300x182.jpg"
metaDescription: "Simple solution to make Actors and Meshes transparent when they block the player from the camera. Custom Player Controller and no other changes."
type: "post"
---
...
A derived Player Controller from Occlusion Aware Player Controller either by C++ or Blueprint must call `SyncOccludedActors` constantly (I set it with a timer in Blueprint, see the example below).
...
-   The source-code is at the bottom of this post and also on [GitHub](https://gist.github.com/alfredbaudisch/7978f1913e76640e2dc25b770ffa6ae1).
...
<figure class="wp-block-image">
  <a href="/media/wp-content/2022/05/image.png"><img src="/media/wp-content/2022/05/image-1024x469.png" alt="" loading="lazy"></a>
  <figcaption>Click to see the full material.</figcaption>
</figure>
...
<figure class="wp-block-image">
  ...
  <figcaption>Configure the Occlusion and See-Through</figcaption>
</figure>
...
[![](/media/wp-content/2022/05/image-2.png)](/media/wp-content/2022/05/image-2.png)
...
[![](/media/wp-content/2022/05/image-3.png)](/media/wp-content/2022/05/image-3.png)
